...
public class UserService {
    ...
    public UserDTO findById(long id) {
        ...
        if (user.getProjects() != null && user.getProjects().size() > 0) {
            projectsDTO = user.getProjects().stream()
    ...
    public User create(User user) {
        ...
        if (user.getName() == null || user.getName().isBlank()) throw new UserFieldNotValidException("name");
    ...
    public User update(User user) {
        ...
        if (user.getEmail() == null || !isValidEmail(user.getEmail())) throw new UserEmailNotValidException();
        if (user.getName() == null || user.getName().isBlank()) throw new UserFieldNotValidException("name");
