package com.example.projectsapp.projectsapp.unit.controller;

import com.example.projectsapp.projectsapp.controller.ProjectController;
...
import static com.example.projectsapp.projectsapp.util.Util.convertToResponse;
...
public class ProjectControllerTest {
    ...
    void testFindAll_Success() {
        ...
        List<ProjectDTO> projectDTOList = List.of(
                new ProjectDTO(1L, name1, description1),
                new ProjectDTO(2L, name2, description2)
        );
        ...
        assertEquals(convertToResponse(projects, "projects"), response.getBody());
