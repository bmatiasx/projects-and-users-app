...
import com.example.projectsapp.projectsapp.controller.UserController;
import com.example.projectsapp.projectsapp.dto.UserDTO;
...
public class UsersControllerTest {
    ...
    public void testFindAll_Success() {
        ...
        assertEquals(convertToResponse(users, "users"), response.getBody());
